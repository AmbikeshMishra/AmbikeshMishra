...
## What I build
- 🤖 Agentic AI workflows — LangGraph, LangChain, CrewAI
- 📚 RAG systems with cited answers over business documents & warehouses
- 📊 Natural-language analytics on Snowflake / Power BI
- ⚙️ Document & reporting automation (e.g., P&L PDF reader)

## Featured work

| Project | What it shows |
|---|---|
| **[Claims Copilot: Fraud Triage Agent](https://github.com/AmbikeshMishra/claims-copilot-fraud-triage-agent)** — [live demo](https://claims-copilot-fraud-triage-agent-kvrlaonnzuxr5msemgjg9t.streamlit.app) | Upload a health insurance claim → an agent extracts the facts, runs 5 explainable fraud signals, and produces an adjuster-style triage report (AUTO-APPROVE / STANDARD REVIEW / INVESTIGATE). Built on the same fraud-modeling domain I worked in at Max Bupa — LangGraph, PyMuPDF, transparent scoring (no black-box ML) |
